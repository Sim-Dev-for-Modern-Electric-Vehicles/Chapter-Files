...
<model name="lat_dyn_v3">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="11/04/22 11:08:02"/>
  ...
  <diagram>
    <block name="ContStateSpace" type="block">
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="A" value="[ 0,1,0,0;0,-(Caf+Car)/m/u0, (Caf+Car)/m, (b*Car-a*Caf)/m/u0;0,0,0,1;0,(-a*Caf+b*Car)/Iz/u0,(a*Caf-b*Car)/Iz, -(a^2*Caf+b^2*Car)/Iz/u0]"/>
    ...
    <block name="Scope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="615.06396484375" y="-167.51504516601562"/>
    ...
    <block name="SignalGenerator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="69.48681640625" y="-78.92929077148447"/>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="xx" value="[0 1 6  8 13 14 19 20  25 27 32 33 40]"/>
          <parameter name="yy" value="[0 1 1 -1 -1 0  0  -1  -1  1 1   0  0] "/>
          <parameter name="typ" value="&apos;double&apos;"/>
    ...
    <block name="Gain" type="block">
      ...
      <graphics>
        ...
        <background color="255,255,255,255"/>
        <position x="167.74732971191406" y="-78.92929077148438"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.4" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">delSt</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="gain" value="delSt"/>
          <parameter name="overflow" value="&apos;Nothing&apos;"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="Scope_1_2" type="block">
      <template name="system/SignalViewers/Scope"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="0"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="271.8013916015625" y="-171.4307861328125"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="218.15225219726562" y="-58.929290771484375"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        ...
        <point x="504.0156707763672" y="-113.51504516601562"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="533.536376953125" y="58.66789245605469"/>
        <point x="533.536376953125" y="-41.515045166015625"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="520.1021728515625" y="5.570709228515625"/>
        <point x="520.1021728515625" y="-77.51504516601562"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Scope_1_2" port="1" iotype="in"/>
      <to block="Block" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="218.15225219726562" y="-156.4307861328125"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Scope_1_2" port="2" iotype="in"/>
      <to block="Block_1" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="229.44427490234375" y="-126.4307861328125"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
